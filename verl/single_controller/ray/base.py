...
def create_colocated_worker_cls(class_dict: dict[str, RayClassWithInitArgs]):
    ...
    class WorkerDict(worker_cls):
        def __init__(self):
            ...
            # Expose colocated workers to each inner worker. This mirrors the
            # fused-worker path and lets workers access sibling roles when a
            # recipe needs local cross-role integration.
