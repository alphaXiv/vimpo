...
def need_reference_policy(
    ...
    use_vimpo_loss = bool(config.get("vimpo_config", {}).get("use_vimpo_loss", False))
    return config.algorithm.use_kl_in_reward or config.actor_rollout_ref.actor.use_kl_loss or use_vimpo_loss
